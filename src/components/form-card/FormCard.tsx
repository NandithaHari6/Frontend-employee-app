      ...
      <div className="form">
        <div className="row">
          ...
          <FormInput
            ...
            value={moment(values.dateOfJoining).format("YYYY-MM-DD").slice(0,10)}
       ...
       {/* <FormInput
        ...
        <div className="row">
          <div className="address">
            <label>Address</label>
            <FormInput type="text" placeholder="House No" value={addressValues.houseNo}
            onChange={(e) => addressOnChange("houseNo", (e.target.value))} c/>
            <FormInput type="text" placeholder="line1"  value={addressValues.line1}
            onChange={(e) => addressOnChange("line1", e.target.value)}/>
            <FormInput type="text" placeholder="line2"  value={addressValues.line2}
            onChange={(e) => addressOnChange("line2", e.target.value)}/>
                        <FormInput type="text" placeholder="pincode"  value={addressValues.pincode}
        ...
        <div className="buttons">
          {isEdit ? (
            ...
            <Button title="Submit" className="primary-btn" onClick={handleSubmit}/>
          )}
          <Button title="Cancel" className="secondary-btn" onClick={clearForm} />
        </div>
      </div>
    </>
  );
